package com.lega.practica8.onboarding;
...
import com.lega.practica8.MainActivity;
import com.lega.practica8.databinding.FragmentOnBoardingPage3Binding;
...
public class OnBoardingPage3 extends Fragment {
    ...
    private void listener(){
        binding.FOP3Login.setOnClickListener(new View.OnClickListener() {
            @Override
